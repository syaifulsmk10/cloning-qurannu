    ...
    <>
      ...
      <div className={`App ${isDarkMode ? "dark" : "light"}`}>
        ...
        <div class="left-content">
          ...
          <div class="ayat">
            <h1>قُلْ اَعُوْذُ بِرَبِّ النَّاسِ</h1>
          </div>
        ...
        <div class="left-content">
          ...
          <div class="ayat">
            <h1>مِنۡ شَرِّ الۡوَسۡوَاسِ  ۙ الۡخَـنَّاسِ</h1>
          </div>
          <div class="clearfix"></div>
        </div>
        <hr />
        ...
        <div class="left-content">
          ...
          <div class="ayat">
            <h1>الَّذِىۡ يُوَسۡوِسُ فِىۡ صُدُوۡرِ النَّاسِۙ</h1>
          </div>
        </div>
        <hr />
        ...
        <div class="left-content">
          ...
          <div class="ayat">
            <h1>مِنَ الۡجِنَّةِ وَالنَّاسِ</h1>
          </div>
        </div>
        <hr />
      </div>
