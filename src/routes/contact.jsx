    ...
    <>
      ...
      <div className={`App ${isDarkMode ? "dark" : "light"}`}>
        <div className="atass">
          ...
          <div class="bawah">
            <div class="daftar">
              ...
              <p class="surat">Daftar Surat</p>
            </div>

            <div>
              <a href="">
                <button class="judul">Al Baqarah</button>
              </a>
              <a href="">
                <button>.</button>
              </a>
              <div class="dropdown">
                ...
                <select id="bahasa">
                  ...
                  <option value="cpp">4</option>
                  <option value="php">5</option>
                  <option value="php">6</option>
                  <option value="php">7</option>
                </select>
              </div>
            </div>
            <div class="setting">
              <p class="surat">Pengaturan</p>
        ...
        <div class="left-content">
          <div class="icon">
            <i class="fa-solid fa-ellipsis-vertical flex-left"></i>
          </div>
          <div class="ayat">
        ...
        <div class="left-content">
          ...
          <div class="ayat">
            <h1>اَلْحَمْدُ لِلّٰهِ رَبِّ الْعٰلَمِيْنَ</h1>
          </div>
          <div class="clearfix"></div>
        </div>
        <hr />
        ...
        <div class="left-content">
          ...
          <div class="ayat">
            <h1>اِيَّاكَ نَعْبُدُ وَاِيَّاكَ نَسْتَعِيْنُ</h1>
          </div>
        </div>
        <hr />
        ...
        <div class="left-content">
          ...
          <div class="ayat">
            <h1>اِھْدِنَا الصِّرَاطَ الْمُسْتَـقِيْمَ</h1>
          </div>
        </div>
        <hr />
        ...
        <div className="left-content">
          ...
          <div class="ayat">
            <h1>
              صِرَاطَ الَّذِيۡنَ اَنۡعَمۡتَ عَلَيۡهِمۡ ۙ غَيۡرِ الۡمَغۡضُوۡبِ
              عَلَيۡهِمۡ وَلَا الضَّآلِّيۡنَ
            </h1>
          </div>
        </div>
