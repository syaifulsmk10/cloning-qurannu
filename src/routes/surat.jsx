      ...
      <div className={`App ${isDarkMode ? "dark" : "light"}`}>
        <div className="atass">
          ...
          <div class="bawah">
            ...
            <div>
              <a href="">
                <button class="judul">An Nas</button>
              </a>
              <a href="">
                <button>Al Fatihah</button>
              </a>
              <div class="dropdown">
                <select id="bahasa">
        ...
        <div class="left-content">
          ...
          <div class="ayat">
            <h1>قُلۡ هُوَ اللّٰهُ اَحَدٌ‌</h1>
          </div>
        ...
        <div class="left-content">
          ...
          <div class="ayat">
            <h1>لَمۡ يَلِدۡ ۙ وَلَمۡ يُوۡلَدۡ</h1>
          </div>
          <div class="clearfix"></div>
        </div>
        <hr />
        ...
        <div class="left-content">
          ...
          <div class="ayat">
            <h1>وَلَمۡ يَكُنۡ لَّهٗ كُفُوًا اَحَدٌ</h1>
          </div>
          <div class="clearfix"></div>
        </div>
        <hr />
