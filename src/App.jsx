      ...
      <div className={`App ${isDarkMode ? "dark" : "light"}`}>
        <div className="atas">
          ...
          <div className={`App ${isDarkMode ? "dark" : "light"}`}>
            ...
            <img src="logo-white.png" alt="" class="logos" />

            <svg className="logo" viewBox="0 0 82 80">
              <path
        ...
        <div class="content">
          <div className="hori">
            <div className="card">
              ...
              <div class="flex-row items-center pl-5">
                {" "}
                <h4 class="text-lg font-semibold text-grey-800 dark:text-white">
                  Al-Fatihah
                </h4>{" "}
                <p class="text-sm text-grey-600 dark:text-grey-500">
                  Makkiyah - 7 Ayat
                </p>{" "}
              </div>
            </div>
            ...
            <div className="card">
              ...
              <div class="flex-row items-center pl-5">
                {" "}
                <h4 class="">Ali-Imran</h4>
                <p class="">Madaniyah - 200 Ayat</p>
        ...
        <div class="footer">
          ...
          <div class="gambar">
            <img src="googleplay@3x.png" alt="" />
            <img src="appstore@3x.png" alt="" />
          </div>
        </div>

        <div class="bawah">
          <p class="ha">Copyright © 2022 NU Online</p>
        </div>
      </div>
